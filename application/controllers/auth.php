...
class Auth extends CI_Controller {
	...
	function products(){
		...
		$data['login'] = true;
		$data['title'] = 'Products';
		$this->_render_page('auth/products', $data);
	}
	function projects(){
		if (!$this->ion_auth->logged_in())
		{
		...
		$this->_render_page('auth/projects', $data);
	}
	...
	function viewaddproject(){
		...
		$this->_render_page('auth/viewaddproject', $data);
	}
	function addproject(){
		if (!$this->ion_auth->logged_in())
		{
	...
	function changestatus($id, $value){
		...
		$where['id'] = $id;
		$save['status'] = $value;
		$this->cmodel->update('projects', $save, $where);
		redirect('auth/projects');
	}
	function banner(){
		if (!$this->ion_auth->logged_in())
		...
		$data['login'] = true;
		$data['title'] = 'Banner';
		$this->_render_page('auth/banner', $data);
	}
